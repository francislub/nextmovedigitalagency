    ...
    <main className="min-h-screen bg-background text-foreground font-mono">
          ...
          {contactInfo.map((info, index) => {
            ...
            return (
              ...
              >
                ...
                <a
                  href={info.href}
                  className="text-foreground/70 hover:text-primary transition-colors font-medium tracking-wide break-words"
                >
                  {info.value}
                </a>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="animate-slideInRight">
            ...
            <div className="space-y-6">
              {[
                { title: 'Expert Team', description: 'Our team brings years of experience in digital transformation.' },
                { title: 'Fast Response', description: 'We respond within 24 hours to keep your project moving.' },
                { title: 'Custom Solutions', description: 'Tailored services to your unique business needs.' },
                { title: 'Proven Results', description: 'Clients see measurable growth in online engagement.' },
                { title: 'Transparent Communication', description: "Clear updates and progress reports." },
                { title: 'Ongoing Support', description: "We provide continuous optimization and support." },
              ].map((item, index) => (
                <div
                  key={item.title}
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
          ...
          <Link
            href="/consultation"
            className="px-8 py-4 bg-gradient-to-r from-primary to-secondary text-primary-foreground font-bold uppercase tracking-widest rounded-lg hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 transform hover:scale-105"
          >
