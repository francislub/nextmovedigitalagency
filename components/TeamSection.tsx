              ...
              >
                <div className="relative h-full rounded-2xl border border-border/50 group-hover:border-primary/30 bg-card/50 backdrop-blur-sm p-6 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="relative text-center">
                    {/* Avatar */}
                    <div
                      className="w-20 h-20 rounded-2xl bg-gradient-to-br flex items-center justify-center text-white text-3xl font-extrabold mb-4 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300"
                      style={{
