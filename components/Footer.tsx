          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-4 py-2 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-lg font-semibold text-sm flex items-center justify-center gap-2 tracking-wide hover:shadow-lg hover:shadow-primary/40 transition-all disabled:opacity-60"
              >
            ...
            {message && (
              <p className="text-xs mt-2 text-primary tracking-wide">
                {message}
              </p>
            )}
          </div>
