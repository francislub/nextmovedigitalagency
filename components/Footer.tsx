            ...
            <div>
              ...
              <Link href="/" className="flex items-center mb-3">
                ...
                <img
                  ...
                  alt="NextMove"
                  className="block dark:hidden max-w-[150px] sm:max-w-[150px] md:max-w-[200px] lg:max-w-[200px] h-auto object-contain"
                />

                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/black-iXsseJTvyXimXjpRcnVLUKTT4S6pv2.png"
                  alt="NextMove"
                  className="hidden dark:block max-w-[150px] sm:max-w-[150px] md:max-w-[200px] lg:max-w-[200px] h-auto object-contain"
                />
